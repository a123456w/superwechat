...
import cn.ucai.easeui.controller.EaseUI.EaseSettingsProvider;
...
import cn.ucai.easeui.model.EaseNotifier.EaseNotificationInfoProvider;
...
public class SuperWeChatHelper {
                    ...
                    public void onSuccess(String s) {
                        if(s!=null){
                            ...
                            if(result!=null&&result.isRetMsg()){
                                ...
                                if(user!=null){
                                    Log.i("main","addContacted.addContact.user="+user);
                                    saveContact2(user);
                                }
                            }
                        }
    ...
    private void saveContact2(User user) {
        ...
        if (!localUsers.containsKey(user.getMUserName())) {
            Log.i("main","saveContact2.user.toString="+user);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    model.loadContactAllList(appContext, EMClient.getInstance().getCurrentUser(), new OnCompleteListener<String>() {
                        @Override
                        public void onSuccess(String s) {
                            if(s!=null){
